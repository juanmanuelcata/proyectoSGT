...
<form class="form-horizontal" name="formi" action="./obraSocial.php" method="GET">
    <fieldset>
        ...
        <div class="control-group">
            ...
            ?>
             <button class="btn" onclick="return false;" data-original-title="Estado de la obra social" data-content="Oprima sobre alguno de los campos para modificar el estado de la obra social.">
                <i class="icon-question-sign"></i>
            </button>
