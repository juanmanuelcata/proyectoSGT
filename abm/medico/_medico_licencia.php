...
//mi codigo laucha
            ...
            if (($hasta < $desde) || ($desde < $hoy)) {
              ...
              if ($result->rowCount() > 0) {
                echo '<div class="alert alert-error">  
                <a class="close" data-dismiss="alert">×</a>  
                <strong><h4>Error!</h4> El medico tiene una licencia pendiente o en curso.</strong> 
             </div>';
              } else {
                ...
                if ($result->rowCount() > 0) {
                  echo '<div class="alert alert-error">  
                <a class="close" data-dismiss="alert">×</a>  
                <strong><h4>Error!</h4> El medico tiene turnos pendientes en ese intervalo.</strong> 
             </div>';
                } else {
                ...
                values ('$desde', '$hasta', '$idmedico')";
                  if ($db->query($consulta)) {
                    ...
                    Se incerto correctamente la licencia.</h4>  
                </div>';
                  } else {
                    echo '<div class="alert alert-error">  
                <a class="close" data-dismiss="alert">×</a>  
          ...
          <script>
            ...
            $(document).ready(function() {
              $('#tabla1').dataTable({
                ...
                "oLanguage": {
                  "sLengthMenu": 'Mostrando de: <select>' +
