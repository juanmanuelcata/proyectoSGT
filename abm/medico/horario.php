<div id="horario_div_<?php echo $_POST['numeroHorario']; ?>" class="nuevoHorario">
    ...
    <fieldset>
        ...
        <label>Día</label>
        <select class="span5" name="horario[<?php echo $_POST['numeroHorario']; ?>][dia]" id="dia<?php echo $n; ?>" onchange="propio('horario_div_<?php echo $_POST['numeroHorario']; ?>');">
        ...
        <label>Desde</label>
        <select class="span5" name="horario[<?php echo $_POST['numeroHorario']; ?>][desde]" id="horarios<?php echo $n; ?>" onchange="propio('horario_div_<?php echo $_POST['numeroHorario']; ?>');">
        ...
        <label>Hasta</label>
        <select class="span5" name="horario[<?php echo $_POST['numeroHorario']; ?>][hasta]" id="horariosHasta<?php echo $n; ?>" onchange="propio('horario_div_<?php echo $_POST['numeroHorario']; ?>');">
            <option selected="selected">Elija un horario</option>
            <?php
            for ($i = 8; $i < 20; $i++) {
                echo "<option value=\"$i:00:00\">$i:00</option>";
