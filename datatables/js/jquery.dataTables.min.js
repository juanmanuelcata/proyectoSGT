...
(function(j, qa, p) {
    ...
    n.oPagination = {two_button: {fnInit: function(g, m, r) {
                ...
                j("span", m).bind("mousedown", function() {
                    return false
                ...
                if (g.aanFeatures.p) {
                    ...
                    for (r = s; r <=
                            x; r++)
                        F += y != r ? '<span class="' + v.sPageButton + '">' + r + "</span>" : '<span class="' + v.sPageButtonActive + '">' + r + "</span>";
                    x = g.aanFeatures.p;
                    var z, U = function() {
    ...
    n.oSort = {"string-asc": function(g, m) {
            ...
            if (isNaN(m) ||
                    m === "")
                m = Date.parse("01/01/1970 00:00:00");
            return g - m
            ...
            if (isNaN(m) || m === "")
                m = Date.parse("01/01/1970 00:00:00");
            return m - g
        }, "numeric-asc": function(g, m) {
            return(g == "-" || g === "" ? 0 : g * 1) - (m == "-" || m === "" ? 0 : m * 1)
        }, "numeric-desc": function(g, m) {
            return(m == "-" || m === "" ? 0 : m * 1) - (g == "-" || g === "" ? 0 : g * 1)
        }};
    n.aTypes = [function(g) {
            if (g.length === 0)
                return"numeric";
    ...
    j.fn.dataTable = function(g) {
        function m() {
            ...
            this.aanFeatures = [];
            this.oLanguage = {sProcessing: "Procesando...",
                sLengthMenu: "Show _MENU_ entries", sZeroRecords: "No se encontraton coincidencias en los registros", sEmptyTable: "No hay datos disponibles para esta tabla", sInfo: "Mostrando _START_ a _END_ de _TOTAL_ entradas", sInfoEmpty: "Mostrando 0 a 0 de 0 entradas", sInfoFiltered: "(Filtrado de MAX_ total entradas)", sInfoPostFix: "", sSearch: "buscar:", sUrl: "", oPaginate: {sFirst: "Primera", sPrevious: "Previa", sNext: "Proxima", sLast: "Ultima"}, fnInfoCallback: null};
            this.aoData = [];
            this.aiDisplay = [];
        ...
        function F(a,
            ...
            if (typeof a.aoPreSearchCols[b] == "undefined" || a.aoPreSearchCols[b] ===
                    null)
                a.aoPreSearchCols[b] = {sSearch: "", bRegex: false, bSmart: true};
            else {
                if (typeof a.aoPreSearchCols[b].bRegex == "undefined")
                    a.aoPreSearchCols[b].bRegex = true;
                if (typeof a.aoPreSearchCols[b].bSmart == "undefined")
                    a.aoPreSearchCols[b].bSmart = true
            }
            x(a, b, null)
        }
        function x(a, b, c) {
        ...
        function z(a) {
            ...
            for (d = a.aoColumns.length; h < d; h++) {
                if (a.aoColumns[h].sTitle === null)
                    a.aoColumns[h].sTitle = a.aoColumns[h].nTh.innerHTML;
                    ...
                    for (c = a.aoData.length; b < c; b++) {
                        ...
                        if (f)
                            if (a.aoColumns[h].sType != "string") {
                                ...
                                if (a.aoColumns[h].sType === null)
                                    a.aoColumns[h].sType = t;
                                else if (a.aoColumns[h].sType != t)
                                    a.aoColumns[h].sType = "string"
                            }
                        if (e) {
                            t =
                                    a.aoColumns[h].fnRender({iDataRow: b, iDataColumn: h, aData: a.aoData[b]._aData, oSettings: a});
                            q.innerHTML = t;
                            if (a.aoColumns[h].bUseRendered)
                                a.aoData[b]._aData[h] = t
                        }
                        if (k)
                            q.className += " " + a.aoColumns[h].sClass;
                        if (l)
                            a.aoData[b]._anHidden[h] = null;
                        else {
            ...
            if (a.nTFoot !== null) {
                ...
                for (d = c.length; b < d; b++)
                    if (typeof a.aoColumns[b] != "undefined") {
                        ...
                        if (a.oClasses.sFooterTH !== "")
                            a.aoColumns[b].nTf.className += " " + a.oClasses.sFooterTH;
                        f = 1;
                        for (e = i.length; f < e; f++) {
                            k = j(i[f]).children();
            ...
            if (!(!a.bDestroying && a.oFeatures.bServerSide && !sa(a))) {
                ...
                if (a.aiDisplay.length !== 0) {
                    ...
                    for (i =
                        ...
                        if (c !== 0)
                            for (k = 0; k < c; k++)
                                l == a.aoOpenRows[k].nParent && d.push(a.aoOpenRows[k].nTr)
                    }
                } else {
                ...
                for (b =
                        a.aoDrawCallback.length - 1; b >= 0; b--)
        ...
        function sa(a) {
            if (a.bAjaxDataGet) {
                ...
                if (a.oFeatures.bSort !==
                    ...
                    for (d = 0; d < b; d++)
                        c.push({name: "bSortable_" + d, value: a.aoColumns[d].bSortable})
                }
        ...
        function ta(a, b) {
            ...
            if (c = typeof b.sColumns != "undefined" && c !== "" && b.sColumns != c)
                var d = ua(a, b.sColumns);
            for (var f = 0, e = b.aaData.length; f < e; f++)
                if (c) {
                    for (var i = [], h = 0, k = a.aoColumns.length; h < k; h++)
            ...
            for (var c = a.nTableWrapper, d = a.sDom.split(""), f, e, i, h, k, l, q, t = 0; t < d.length; t++) {
                ...
                if (i == "<") {
                    ...
                    if (k == "'" || k == '"') {
                        ...
                        if (l == "H")
                            l = "fg-toolbar ui-toolbar ui-widget-header ui-corner-tl ui-corner-tr ui-helper-clearfix";
                        else if (l == "F")
                            l = "fg-toolbar ui-toolbar ui-widget-header ui-corner-bl ui-corner-br ui-helper-clearfix";
                        if (l.indexOf(".") != -1) {
                            k = l.split(".");
                            h.setAttribute("id", k[0].substr(1, k[0].length - 1));
                            h.className = k[1]
                        } else if (l.charAt(0) == "#")
                            h.setAttribute("id", l.substr(1, l.length - 1));
                        else
                            h.className = l;
                        t += q
                    }
        ...
        function Ba(a) {
            ...
            if (a.oScroll.sX === "") {
                ...
                if (j.browser.msie && j.browser.version <= 7)
                    a.nTable.style.width = u(j(a.nTable).outerWidth() - a.oScroll.iBarWidth)
                ...
                if (j(a.nTable).outerWidth() > f - a.oScroll.iBarWidth)
            ...
            if (j(a.nTable).outerWidth() < f)
                if (a.oScroll.sX === "")
                    H(a, 1, "The table cannot fit into the current element which will cause column misalignment. It is suggested that you enable x-scrolling or increase the width the table has in which to be drawn");
                else
                    a.oScroll.sXInner !== "" && H(a, 1, "The table cannot fit into the current element which will cause column misalignment. It is suggested that you increase the sScrollXInner property to allow it to draw in a larger area, or simply remove that parameter to allow automatic calculation");
            if (a.oScroll.sY === "")
                if (j.browser.msie && j.browser.version <= 7)
            ...
            if (a.oScroll.sY !== "" && a.oScroll.bCollapse) {
                ...
                if (a.nTable.offsetHeight < d.offsetHeight)
                    d.style.height = u(j(a.nTable).height() + h)
            }
        ...
        function wa(a) {
            ...
            c.keyup(function() {
                for (var d = a.aanFeatures.f, f = 0, e = d.length; f < e; f++)
                    d[f] != this.parentNode && j("input", d[f]).val(this.value);
        ...
        function P(a, b, c) {
            ...
            for (b = 0; b < a.aoPreSearchCols.length; b++)
                Da(a, a.aoPreSearchCols[b].sSearch, b, a.aoPreSearchCols[b].bRegex, a.aoPreSearchCols[b].bSmart);
        ...
        function ka(a, b) {
            for (var c = "", d = p.createElement("div"), f = 0, e = a.aoColumns.length; f < e; f++)
                if (a.aoColumns[f].bSearchable)
                    c += ja(b[f], a.aoColumns[f].sType) + "  ";
            if (c.indexOf("&") !== -1) {
                d.innerHTML = c;
            ...
            if (!a.oFeatures.bServerSide && (a.aaSorting.length !== 0 || a.aaSortingFixed !== null)) {
                ...
                for (f = 0; f < k.length; f++) {
                    ...
                    if (typeof n.afnSortData[h] !=
                        ...
                        i = 0;
                        for (h = t.length; i < h; i++)
                            t[i]._aData[e] = J[i]
                    }
                }
                f = 0;
                for (e = a.aiDisplayMaster.length; f < e; f++)
                    l[a.aiDisplayMaster[f]] = f;
                var B = k.length;
                        ...
                        if (f.shiftKey) {
                            for (var k = false, l = 0; l < a.aaSorting.length; l++)
                                if (a.aaSorting[l][0] == c) {
                                    ...
                                    i = a.aaSorting[l][0];
                                    h = a.aaSorting[l][2] + 1;
                                    if (typeof a.aoColumns[i].asSorting[h] == "undefined")
                                        a.aaSorting.splice(l, 1);
                                    else {
        ...
        function T(a) {
            ...
            for (b =
                    0; b < i; b++)
                a.aoColumns[b].bSortable && j(a.aoColumns[b].nTh).removeClass(h.sSortAsc + " " + h.sSortDesc + " " + a.aoColumns[b].sSortingClass);
            ...
            for (b = 0; b < a.aoColumns.length; b++)
                if (a.aoColumns[b].bSortable) {
                    ...
                    j(a.aoColumns[b].nTh).addClass(a.aoColumns[b].sSortingClass);
            e = h.sSortColumn;
                ...
                if (d.length >= i)
                    for (b = 0; b < i; b++)
                        if (d[b].className.indexOf(e + "1") != -1) {
                            c = 0;
                            for (a = d.length / i; c < a; c++)
                                d[i * c + b].className = j.trim(d[i * c + b].className.replace(e + "1", ""))
                        } else if (d[b].className.indexOf(e +
                                "2") != -1) {
                            c = 0;
                            for (a = d.length / i; c < a; c++)
                                d[i * c + b].className = j.trim(d[i * c + b].className.replace(e + "2", ""))
                        } else if (d[b].className.indexOf(e + "3") != -1) {
                            c = 0;
                            for (a = d.length / i; c < a; c++)
                                d[i * c + b].className = j.trim(d[i * c + b].className.replace(" " + e + "3", ""))
                        }
                h = 1;
                var k;
        ...
        function va(a) {
            ...
            j("select", f).change(function() {
                ...
                for (d = i.length; c < d; c++)
                    i[c] != this.parentNode && j("select", i[c]).val(e);
        ...
        function $(a) {
            ...
            if (f == i.length && b === 0 && d == f && a.oScroll.sX === "" && a.oScroll.sY === "")
                ...
                e = j("thead th", b);
                if (e.length === 0)
                    e = j("tbody tr:eq(0)>td", b);
                e.each(function(h) {
                    this.style.width = "";
                    h = ga(a, h);
                    if (h !== null && a.aoColumns[h].sWidthOrig !== "")
                        this.style.width = a.aoColumns[h].sWidthOrig
                });
                for (e = 0; e < f; e++)
                    if (a.aoColumns[e].bVisible) {
                        d = Ha(a, e);
                ...
                if (a.oScroll.sX !== "" && a.oScroll.sXInner !== "")
                    ...
                    b.style.width = "";
                    if (j(b).width() < e.offsetWidth)
                        b.style.width = u(e.offsetWidth)
                ...
                if (f.length === 0)
                    f = j("thead tr:eq(0)>th", b);
                for (e = c = 0; e < a.aoColumns.length; e++)
                    if (a.aoColumns[e].bVisible) {
                        d = j(f[c]).width();
                        if (d !== null && d >
                                0)
                            a.aoColumns[e].sWidth = u(d);
                        c++
                    }
        ...
        function Ia(a, b) {
            if (a.oScroll.sX === "" && a.oScroll.sY !== "") {
                ...
                b.style.width = u(j(b).outerWidth())
        }
        function Ha(a, b, c) {
            ...
            if (c >= 0) {
                b = M(a, b);
                if (a = a.aoData[c].nTr.getElementsByTagName("td")[b])
                    return a
            }
            return null
        }
                ...
                if (d !== null && d !== "") {
                    ...
                    if (typeof c.aaSearchCols != "undefined")
                        for (d = 0; d < c.aaSearchCols.length; d++)
                            a.aoPreSearchCols[d] = {sSearch: decodeURIComponent(c.aaSearchCols[d][0]), bRegex: !c.aaSearchCols[d][1]};
        ...
        function fa(a) {
            ...
            for (i =
                ...
                var t = 0, G = [];
                f = 0;
                for (h = a[d].childNodes.length; f < h; f++)
                    if (a[d].childNodes[f].nodeName.toUpperCase() == "TD" || a[d].childNodes[f].nodeName.toUpperCase() == "TH")
                        G.push(a[d].childNodes[f]);
                f = 0;
            ...
            for (i =
                    b.length; d < i; d++) {
                f = 0;
                for (h = b[d].length; f < h; f++)
                    if (typeof b[d][f] == "object" && typeof c[f] == "undefined")
                        c[f] = b[d][f]
            }
            return c
        }
        ...
        function L(a, b, c) {
            for (var d = 0, f = b.length; d < f; d++)
                for (var e = 0, i = b[d].childNodes.length; e < i; e++)
        ...
        this.fnUpdate = function(a, b, c, d, f) {
            ...
            if (typeof a != "object") {
                ...
                if (e.aoColumns[c].fnRender !== null) {
                    ...
                    if (e.aoColumns[c].bUseRendered)
                        e.aoData[b]._aData[c] = i
                }
                c = M(e, c);
                if (c !== null)
                    e.aoData[b].nTr.getElementsByTagName("td")[c].innerHTML = i
            } else {
        ...
        this.fnSetColumnVis =
                function(a, b, c) {
                    ...
                    if (d.aoColumns[a].bVisible != b) {
                        ...
                        if (b) {
                            for (f = b = 0; f < a; f++)
                                d.aoColumns[f].bVisible && b++;
                            if (b >= S(d)) {
                                l.appendChild(q[a]);
                                l = j(">tr", d.nTHead);
                                f = 1;
                                for (e = l.length; f < e; f++)
                                    l[f].appendChild(d.aoColumns[a].anThExtra[f - 1]);
                                if (i) {
                                    i.appendChild(h[a]);
                                    l = j(">tr", d.nTFoot);
                                    f = 1;
                        ...
                        for (e = d.aoOpenRows.length; f < e; f++)
                            d.aoOpenRows[f].nTr.colSpan = S(d);
                        if (typeof c == "undefined" || c) {
                            X(d);
                            C(d)
                        }
        ...
        this.fnDestroy = function() {
            ...
            if (a.bJUI) {
                ...
                j("th", a.nTHead).removeClass([n.oStdClasses.sSortable, n.oStdClasses.sSortableAsc, n.oStdClasses.sSortableDesc, n.oStdClasses.sSortableNone].join(" "));
            b.appendChild(a.nTable);
            d = 0;
            for (f = a.aoData.length; d < f; d++)
                c.appendChild(a.aoData[d].nTr);
        ...
        return this.each(function() {
            ...
            if (a !== null) {
                ...
                e.sInstance = n._oExternConfig.iNextUnique++;
            if (this.nodeName.toLowerCase() != "table")
                H(e, 0, "Attempted to initialise DataTables on a node which is not a table: " + this.nodeName);
            else {
                e.oInstance = Na;
                e.nTable = this;
                e.oApi = Na.oApi;
                ...
                if (c) {
                    e.asDestoryStrips = ["", ""];
                    if (j(d[0]).hasClass(e.oClasses.sStripOdd))
                        e.asDestoryStrips[0] += e.oClasses.sStripOdd + " ";
                    if (j(d[0]).hasClass(e.oClasses.sStripEven))
                        e.asDestoryStrips[0] += e.oClasses.sStripEven;
                    if (j(d[1]).hasClass(e.oClasses.sStripOdd))
                        e.asDestoryStrips[1] += e.oClasses.sStripOdd + " ";
                    if (j(d[1]).hasClass(e.oClasses.sStripEven))
                    ...
                    for (a = g.aoColumnDefs.length - 1; a >= 0; a--) {
                        ...
                        for (d = l.length; c < d; c++)
                            if (typeof l[c] == "number" && l[c] >= 0) {
                                for (; e.aoColumns.length <= l[c]; )
                                    F(e);
                                x(e, l[c], g.aoColumnDefs[a])
                            } else if (typeof l[c] == "number" && l[c] < 0)
                                x(e, e.aoColumns.length + l[c], g.aoColumnDefs[a]);
                            else if (typeof l[c] == "string") {
                                b = 0;
                                for (f = e.aoColumns.length; b < f; b++)
                                    if (l[c] == "_all" || e.aoColumns[b].nTh.className.indexOf(l[c]) != -1)
                ...
                if (this.getElementsByTagName("tfoot").length > 0)
                    e.nTFoot = this.getElementsByTagName("tfoot")[0];
                if (h)
